...
export default class Farm extends ThreeComponent {
  setup ({ x, y, cx, cy }) {
    ...
    this.shapeA = this.body.addShape(new p2.Box({ width: 0.79, height: 0.555 }), [-0.03, 0.085])
    this.shapeB = this.body.addShape(new p2.Box({ width: 0.18, height: 0.18 }), [-0.03, -0.32])
